    ...
    <View style={styles.requestCard}>
      <View style={styles.requestHeader}>
        ...
        <View style={styles.requesterText}>
          ...
          <Text style={styles.requesterUsername}>
...
export default function CollaborationRequestsScreen() {
  ...
  async function handleToggleAccepting(value: boolean): Promise<void> {
    if (!accessToken || !groupId || !group || savingSetting) {
      return;
    }
  ...
  async function resolveRequest(
    ...
    try {
      ...
      const updated = action === 'ACCEPT'
        ? await acceptPublicGroupCollaborationRequest(
            groupId,
            request.id,
            accessToken,
          )
        : await rejectPublicGroupCollaborationRequest(
            groupId,
            request.id,
            accessToken,
          );
            ...
            <View style={styles.settingCard}>
              ...
              <View style={styles.settingText}>
                ...
                <Text style={styles.settingDescription}>
                  Permite que otras personas pidan colaborar en este grupo público.
                </Text>
              </View>
                ...
                <View style={styles.list}>
                  {pendingRequests.map(request => (
                    <RequestCard
                      ...
                      onAccept={() => {
                        void resolveRequest(request, 'ACCEPT');
                      }}
                      onReject={() => {
                        void resolveRequest(request, 'REJECT');
                      }}
                    />
                  ))}
                </View>
