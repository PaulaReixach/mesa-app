...
const styles = StyleSheet.create({
  ...
  requesterName: { color: colors.text, fontSize: 13, fontWeight: '900' },
  requesterUsername: { color: colors.primary, fontSize: 10, fontWeight: '800' },
  ...
  rejectButtonText: { color: colors.danger, fontSize: 12, fontWeight: '900' },
  acceptButton: { minHeight: 44, flex: 1, alignItems: 'center', justifyContent: 'center', borderRadius: 15, backgroundColor: colors.primary },
  acceptButtonText: { color: colors.white, fontSize: 12, fontWeight: '900' },
